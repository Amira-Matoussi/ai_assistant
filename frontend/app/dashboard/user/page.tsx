...
//   AudioLines, User, Globe, Square, Download, Eye, X
// } from "lucide-react"
...
//           <div>
//             <h1 className="text-3xl font-bold text-gray-900 mb-2">My Conversation Sessions</h1>
...
//                     {sessions.reduce((total, session) => total + (sessionMessages.filter(m => m.audio_path).length || 0), 0)}
//                   </p>
//                 </div>
//                 <div className="p-3 bg-gray-50 rounded-lg">
...
//                 <h3 className="text-lg font-medium text-gray-600 mb-2">No conversation sessions yet</h3>
//                 <p className="text-gray-500 mb-4">Start chatting with your AI assistant to see your conversation history here.</p>
//                 <Link href="/assistant">
